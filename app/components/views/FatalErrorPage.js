          ...
          <div className="fatal-error-area">
            {daemonError && (
              <div className="fatal-error">
                <T id="fatal.daemon.title" m="Daemon Error" /> {daemonError}
              </div>
            )}
            {walletError && (
              <div className="fatal-error">
                <T id="fatal.wallet.title" m="Wallet Error" /> {walletError}
              </div>
            )}
          </div>
          <div className="fatal-error-title">
            <T id="fatal.suggestion.title" m="Suggested action to resolve error" />:
          </div>
          <div className="fatal-error-area">
