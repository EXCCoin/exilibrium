...
function mapNonWalletOutput(output) {
  ...
  const amount =
    output.getScriptClass() === DecodedTransaction.Output.ScriptClass.NULL_DATA ? (
      "[null data]"
    ) : (
...
const TxDetails = ({
  ...
  if (decodedTransaction) {
    ...
    nonWalletInputs = decodedTransaction.transaction
      .getInputsList()
      .filter((v, i) => walletInputIndices.indexOf(i) === -1)
      .map(mapNonWalletInput);
    nonWalletOutputs = decodedTransaction.transaction
      .getOutputsList()
      ...
      <div className="txdetails-top">
        ...
        <div className="txdetails-overview">
          <div className="txdetails-input-area">
            ...
            <div className="txdetails-input-arrow" />
