...
const messages = defineMessages({
  ...
  step0Textp1: {
    ...
    defaultMessage:
      " where all activity that takes place is stored. It is like a global, decentralised spreadsheet or ledger that records all the activity that happens when EXCC funds are transferred, keeping track of how many tokens are sent, and what the balance of every account is."
  },
  step0Textp2: {
  ...
  step0Textp3: {
    ...
    defaultMessage:
      "EXCC uses an innovative hybrid proof-of-work (PoW) proof-of-stake (PoS) for validating the transactions, keeping the network secure and making decisions on the consensus rules."
  },
  step0Textp4: {
    id: "tutorial.step.0.text.p4",
    defaultMessage:
      "In return for participation, miners (PoW) and stakers (PoS) are rewarded with newly generated EXCC tokens."
  },
  step1Title: {
  ...
  step1Textp1: {
    ...
    defaultMessage:
      "It can be used to send and receive EXCC funds, and acts as a personal ledger of transactions."
  },
  step1Textp2: {
    id: "tutorial.step.1.text.p2",
    defaultMessage:
      "Exilibrium Wallet can also be used for participating in staking (PoS) and project governance by time-locking your funds in return for tickets."
  },
  step2Title: {
  ...
  step2Textp1: {
    ...
    defaultMessage: "Wallets are deterministically generated by a wallet seed. The mnemonic"
  },
  step2TextBoldp1: {
  ...
  step2Textp3: {
    ...
    defaultMessage:
      "If the wallet encryption passphrase is forgotten or the wallet is destroyed (e.g. computer breaks), the seed can be used to recover the wallet. Same seed can also be used to export your wallet to other EXCC wallet clients."
  },
  step2Textp4: {
  ...
  step3TextLightp1: {
    ...
    defaultMessage:
      "(Unlike Proof-of-Work (PoW) mining that requires computing resources and electricity)."
  },
  step3Textp2: {
  ...
  step3Textp22: {
    ...
    defaultMessage:
      "A successful vote returns the stakeholder a part of the Block Reward plus the original cost of the ticket. In case of missing the vote"
  },
  step3TextLightp22: {
  ...
  step3Textp3: {
    ...
    defaultMessage:
      "Changes are inevitable for all digital currencies, whether deciding on development matters or resolving unexpected problems. EXCC’s innovative governance system is built into the blockchain. This allows for seamless adaption to changes while keeping the existing blockchain ecosystem safe. The same tickets are also used as voting power when deciding on consensus changes."
  },
  step3Textp4: {
    id: "tutorial.step.3.text.p4",
    defaultMessage:
      "Staking encourages long term investment in  by giving the stakeholders decision-making power in projects governance as well rewarding them for participation."
  },
  step4Title: {
          ...
          {
            {
              ...
              1: (
                <Aux>
                  <div className="column">
                    <p>
                      <span className="bold">{intl.formatMessage(messages.step1TextBoldp1)} </span>
                      {intl.formatMessage(messages.step1Textp1)}
                    </p>
              ...
              3: (
                <Aux>
                  <div className="column">
                    ...
                    <p>
                      <span className="bold">{intl.formatMessage(messages.step3Textp2)} </span>
                      {intl.formatMessage(messages.step3TextLightp2)}{" "}
                      <span className="bold">{intl.formatMessage(messages.step3Textp22)} </span>
                      {intl.formatMessage(messages.step3TextLightp22)}
                      <span className="bold">{intl.formatMessage(messages.step3Textp23)}</span>
                    </p>
                  </div>
                  <div className="column">
              ...
              4: (
                <Aux>
                  <div className="column">
                    <p>
                      <span className="bold">{intl.formatMessage(messages.step4TextBoldp1)} </span>
                    </p>
