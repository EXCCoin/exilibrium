...
const CreateWallet = ({
  ...
  <Aux>
    <div className="getstarted content">
      <Tooltip text={<T id="createWallet.goBack" m="Go back" />}>
        <div className="go-back-screen-button" onClick={onReturnToExistingOrNewScreen} />
      </Tooltip>
      ...
      <div className="content-text">
        <div className="column">
          <p>
            ...
            <span className="bold">
              <T
                id="creteWallet.writeSeedReminder"
                m="Write down the following seed and save it in a secure location."
              />
            </span>
          </p>
          <p>
            <T
              id="createWallet.nextPromptSeed"
              m="The next prompt will require entering this seed to confirm it has been saved."
            />
          </p>
        </div>
        <div className="column">
          ...
          <p>
            <T
              id="createWallet.lossInfo2"
              m={`{warningNotice}  Failure to keep this seed private can result in the theft of your entire wallet. Under no circumstances should this seed ever be revealed to someone else.
              `}
              values={{
                warningNotice: (
      ...
      <div className="seedArea">
        ...
        <div className="copy">
          <Tooltip text={<T id="createWallet.copy" m="Copy Seed" />}>
            <a className="copy-to-clipboard-icon" onClick={handleCopySeed} />
          </Tooltip>
        </div>
      </div>
