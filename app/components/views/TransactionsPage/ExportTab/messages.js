...
export default {
  transactions: {
    ...
    description: (
      <T id="export.transactions.descr" m="Exports all transactions recorded in the wallet." />
    ),
    fields: [
      {
        name: "time",
        description: <T id="export.transactions.fields.time" m="Date/time of the transaction" />
      },
      {
        name: "hash",
        description: <T id="export.transactions.fields.hash" m="Hash of the transaction (txid)" />
      },
      {
        name: "type",
        description: (
      ...
      },
      {
        name: "fee",
        description: (
          <T id="export.transactions.fields.fee" m="Fee payed by the wallet for the transaction" />
        )
      },
      {
        name: "amount",
  ...
  dailyBalances: {
    ...
    description: (
      <T
        ...
        m="Export the different types of balances, with a daily aggregation."
      />
    ),
    fields: [
      {
      ...
      },
      {
        ...
        description: (
          <T
            id="export.dailyBalances.fields.lockedNonWallet"
            m="Balance locked in immature and live tickets not controlled by the wallet."
          />
        )
      },
      {
        name: "total",
        description: <T id="export.dailyBalances.fields.total" m="Total available balance." />
      },
      {
        name: "sent",
        description: (
  ...
  balances: {
    ...
    description: (
      <T
        ...
        m="Export the different types of balances after each event that changes it."
      />
    ),
    fields: [
      {
        name: "time",
        description: <T id="export.balances.fields.time" m="Date/time that the balance changed" />
      },
      {
        name: "spendable",
        description: (
      ...
      },
      {
        name: "locked",
        description: (
          <T id="export.balances.fields.locked" m="Balance locked in immature and live tickets." />
        )
      },
      {
        name: "lockedNonWallet",
      ...
      {
        name: "total",
        description: <T id="export.balances.fields.total" m="Total available balance." />
      },
      {
        name: "stakeRewards",
        description: (
          <T id="export.balances.fields.stakeRewards" m="Total stake rewards received." />
        )
      },
      {
        name: "stakeFees",
        description: <T id="export.balances.fields.stakeFees" m="Total stake fees paid." />
      },
      {
        name: "totalStake",
        description: (
          <T id="export.balances.fields.totalStake" m="Total amount of EXCC used on staking." />
        )
      }
    ]
  },
  voteTime: {
    ...
    description: (
      <T
        ...
        m="Export a time-to-vote histogram in days (how many days from ticket purchase until the ticket was selected for voting)."
      />
    ),
    fields: [
      {
        name: "daysToVote",
        description: <T id="export.votettime.fields.daysToVote" m="Day bucket" />
      },
      {
        name: "count",
        description: (
          <T id="export.votetime.fields.count" m="How many tickets voted in this day bucket" />
        )
      }
    ]
  },
    ...
    fields: [
      {
        ...
        description: (
          <T id="export.tickets.fields.spenderTimestamp" m="Date/Time of vote/revocation." />
        )
      },
      {
        name: "status",
      ...
      },
      {
        name: "ticketHash",
        description: (
          <T id="export.tickets.fields.ticketStatus" m="Txid of the ticket transaction." />
        )
      },
      {
        name: "spenderHash",
