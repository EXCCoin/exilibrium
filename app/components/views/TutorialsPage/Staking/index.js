...
const Page1 = StandardPage(
  "staking-01",
  <T id="tutorial.staking.page1" m={`EXCC holders can participate in the Staking (Proof-of Stake) process by purchasing tickets. These tickets are used to vote on miners’ Proof-of-Work in order to validate changes to the EXCC blockchain, or on governance proposals within the Politeia system.
