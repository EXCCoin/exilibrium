...
const StakePoolsList = ({
  ...
  <Aux>
    <div className="stakepool-flex-height">
      ...
      <div id="dynamicInput">
        {configuredStakePools.map(({ value: { Host, TicketAddress, PoolFees, Script } }) => (
          <div key={Host} className="stakepool-content-nest-stake-pool">
            ...
            <div className="stakepool-content-nest-settings">
              <div className="stakepool-content-nest-prefix-settings">
                <T id="stakepools.list.form.field.ticketaddress" m="Ticket Address:" />
              </div>
            ...
            <div className="stakepool-content-nest-settings">
              <div className="stakepool-content-nest-prefix-settings">
                <T id="stakepools.list.form.field.poolfees" m="Pool Fees:" />
              </div>
                ...
                <RemoveStakePoolButton
                  ...
                  modalContent={
                    <T
                      ...
                      m="Do you confirm removal of stakepool {stakepool}?"
