...
import { ExccLoading, NoStats } from "indicators";
    ...
    <Aux>
      {hasStats ? (
        <div className="my-tickets-stats-links">
          <ChartLink to="/tickets/statistics/voteTime" icon="vote-time">
            <T id="mytickets.stats.voteTime" m="Vote Time" />
          </ChartLink>
          <ChartLink to="/tickets/statistics/roi" icon="roi">
            <T id="mytickets.stats.roi" m="ROI" />
          </ChartLink>
        </div>
      ) : (
      ...
      <div className="my-tickets-charts">
        {getMyTicketsStatsRequest ? (
          ...
          <Switch>
            ...
            {hasStats ? (
              <Redirect from="/tickets/statistics" exact to="/tickets/statistics/voteTime" />
            ) : null}
          </Switch>
        )}
      </div>
