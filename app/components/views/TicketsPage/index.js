...
const PageHeader = () => (
  <TitleHeader iconClassName="tickets" title={<T id="tickets.title" m="Tickets" />} />
);
  ...
  <DescriptionHeader
    description={
      <T
        ...
        values={{
          ticketPrice: <Balance amount={ticketPrice} classNameWrapper="header-small-balance" />
        }}
      />
    }
  />
...
export default () => (
  <TabbedPage
    ...
    tabs={[
      ...
      {
        path: "/tickets/governance",
        component: GovernanceTab,
        header: TabHeader,
        link: <T id="tickets.tab.governance" m="Governance" />
      },
      {
