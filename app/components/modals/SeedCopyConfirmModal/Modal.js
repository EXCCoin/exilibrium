    ...
    <div className="confirm-seed-copy-modal-content">
      <p className="confirm-seed-copy-warning-text">
        <T
          ...
          If you want to learn more about seed security, please check our wallets & seeds FAQ located {seedFaqURL}.
          ...
          values={{
            seedFaqURL: (
              <ExternalLink href="https://support.excc.co/hc/en-us/articles/360007665471">
                here
              </ExternalLink>
            ),
            confirmationPhrase: (
