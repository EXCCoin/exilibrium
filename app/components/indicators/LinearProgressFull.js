    ...
    return (
      <div className="linear-progress">
        {(getDaemonSynced || !disabled) && (
          <div
            className={error ? "linear-progress-bar error" : "linear-progress-bar"}
        ...
        <div
          className={
            getDaemonSynced || !disabled ? "linear-progress-text loading" : "linear-progress-text"
          }>
          {disabled && !getDaemonSynced ? (
            <T id="loaderBar.Waiting" m="Waiting for daemon connection..." />
          ) : getDaemonSynced ? (
            <T id="loaderBar.Loaded" m="Blockchain loaded" />
          ) : (
