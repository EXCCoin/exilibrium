...
import { withLog, logOptionNoResponseData, withLogNoData, withLogNoResponseData } from "./app";
...
export const getAccountNumber = withLog(
...
export const getTickets = withLog(
  (walletService, startHeight, endHeight) =>
    new Promise((ok, fail) => {
      const tickets = [];
...
export const setAgendaVote = withLog(
