...
import { withLog, withLogNoData, logOptionNoResponseData } from "./index";

const promisify = fn => (...args) =>
  new Promise((ok, fail) => fn(...args, (res, err) => (err ? fail(err) : ok(res))));
...
export const getNextAddress = withLog(
  (walletService, accountNum) =>
...
// into a structure more amenable to use within exilibrium. It stores the block
...
export const publishUnminedTransactions = withLog(
  walletService =>
    new Promise((resolve, reject) => {
